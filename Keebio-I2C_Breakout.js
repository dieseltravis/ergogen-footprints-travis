...
module.exports = {
  ...
  (fp_text user "SCL" (at 1.27 5.08 ${lblrot(p.rot)}) (layer "F.SilkS")
    (effects (font (size 1 1) (thickness 0.15)) (justify ${lbljust(p.rot, 'left')}))
    (tstamp 9a31798b-bf86-4f44-8de2-17d04bbb91d8)
  )
  (fp_text user "SDA" (at 1.27 7.62 ${lblrot(p.rot)}) (layer "F.SilkS")
    (effects (font (size 1 1) (thickness 0.15)) (justify ${lbljust(p.rot, 'left')}))
  ...
  (model "${p.KICAD9_3DMODEL_DIR}/Connector_PinSocket_2.54mm.3dshapes/PinSocket_1x04_P2.54mm_Vertical.step"
    (offset (xyz 0 0 0))
    (scale (xyz 1 1 0.75))
    (rotate (xyz 0 0 0))
  )
